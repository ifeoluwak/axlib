                    ...
                    if (sourceFile.getImportDeclaration('axlib')) {
                        ...
                        if (text && text.includes('typedApiWrapper') && text.includes(typeName)) {
                            const thisFunction = sourceFile
                                .getDescendantsOfKind(SyntaxKind.MethodDeclaration || SyntaxKind.PropertyAssignment)
                            ...
                            if (thisFunction) {
                                if (this.config.fetchType === 'fetch') {
                                    ...
                                    const pp = thisFunction.getFirstDescendantByKind(SyntaxKind.CallExpression);
                                    const identifier = pp
